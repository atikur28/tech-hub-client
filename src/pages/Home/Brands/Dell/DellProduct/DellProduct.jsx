...
const DellProduct = ({ dell }) => {
  const { _id, name, brand, rating, price, type, image } = dell || {};
  return (
    <div className="w-max mx-auto mb-10 border rounded bg-white p-2">
      ...
      <div className="md:flex items-center justify-between mt-2 px-2">
        <h3 className="font-bold text-lg lg:text-2xl w-[250px] md:w-[500px] ">
          {name}
        </h3>
...
DellProduct.propTypes = {
  dell: PropTypes.object,
};
